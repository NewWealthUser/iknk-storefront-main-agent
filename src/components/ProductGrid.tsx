...
export const getUrl = (
  item: any, // This `item` is actually `RhProduct`
  host: string = "",
  stocked: boolean,
  ...
  // The user wants /products/[handle]
  // The `item` is RhProduct, which has a `handle` property.
  const urlPath = `/products/${item?.handle}`; // Simplified to directly use the desired path
