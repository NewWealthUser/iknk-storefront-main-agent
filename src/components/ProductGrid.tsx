...
const ProductGrid: FC<ProductGridProps> = ({
  ...
  const [storedItemsPerPagePreference, setStoredItemsPerPagePreference] = useState<string | null>(null);

  useEffect(() => {
    if (typeof window !== 'undefined') {
      setStoredItemsPerPagePreference(localStorage.getItem(ITEMS_PER_PAGE_PREFERENCE));
    }
  }, []);
