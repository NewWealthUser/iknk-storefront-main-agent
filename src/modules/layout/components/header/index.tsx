...
const Header = () => {
  ...
  const cartCount = cart?.lineItems?.reduce((sum: number, item: IknkLineItem) => sum + (item.quantity || 0), 0) || 0; // Explicitly type sum and item
                    ...
                    <a id="container-rhr-header_logo-rhr" href="https://rh.com/us/en" data-analytics-worhlogo="worh-logo" className="leading-[0]" aria-label="The World of RH Homepage">
                      <svg className="fill-current !h-[46px] !w-[48px] sm:!h-[67px] sm:!w-[70px]" viewBox="0 0 58 55" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clipPath="url(#clip0_11443_87270)">
                          ...
                          <path d="M9.23286 11.0733L7.22862 17.2144H7.11505L5.36067 11.8436H5.33796L3.37915 17.2144H3.26558L0.935314 10.4394C0.709503 9.77073 0.527785 9.43104 0.00668335 9.35214V9.23846H2.56543V9.35214C1.96549 9.37487 1.71697 9.47651 1.71697 9.7373C1.71697 9.82824 1.7624 9.97535 1.7958 10.089L3.67444 15.6858H3.69716L5.23641 11.4932L4.85160 10.3378C4.60307 9.60089 4.39864 9.37487 3.78801 9.35214V9.23846H6.64071V9.35214C5.87109 9.39761 5.70139 9.57815 5.70139 9.91918C5.70139 10.0208 5.76954 10.3271 5.84837 10.5531L7.50120 15.5722H7.52392L8.93891 11.3341C9.13131 10.7564 9.30101 10.1666 9.30101 9.83894C9.30101 9.48721 9.02977 9.38557 8.36169 9.35214V9.23846H10.3312V9.35214C9.83280 9.49925 9.66311 9.74933 9.23286 11.0747V11.0733Z" fill={logoFill} stroke="none"></path>
                          <path d="M14.2368 17.2144C11.2478 17.2144 10.4902 14.6881 10.4902 13.2826C10.4902 9.87232 13.1839 9.13544 14.2942 9.13544C16.1622 9.13544 18.1878 10.4153 18.1878 13.2371C18.1878 14.5397 17.4743 17.2144 14.2368 17.2144ZM14.3730 9.28255C12.9687 9.28255 11.4976 10.5169 11.4976 13.328C11.4976 15.322 12.5171 17.0673 14.2368 17.0673C16.2410 17.0673 17.1803 14.9369 17.1803 13.2264C17.1803 10.3484 15.4032 9.28388 14.3730 9.28388V9.28255Z" fill={logoFill} stroke="none"></path>
                          <path d="M21.9905 13.9179C21.6057 13.5661 21.0165 13.51 20.4967 13.51V16.2288C20.4967 16.852 20.8134 16.9309 21.4587 16.9309V17.0553H18.7423V16.9309C19.3422 16.9309 19.5801 16.852 19.5801 16.2288V10.0649C19.5801 9.45378 19.2861 9.36284 18.7877 9.36284V9.23846C19.7725 9.23846 20.6891 9.19299 21.7086 9.19299C23.0675 9.19299 24.4704 9.72526 24.4704 11.3007C24.4704 12.4682 23.6661 13.0566 22.6479 13.3736C23.3040 13.8149 24.0522 15.2886 24.6521 16.2515C24.9127 16.6701 25.2294 16.9202 25.7384 16.9309V17.0553H23.9948C23.5191 16.2275 22.7040 14.5625 21.9905 13.9165V13.9179ZM21.4133 9.35214C20.8240 9.35214 20.4967 9.45378 20.4967 10.0997V13.3294C20.8935 13.3294 21.2329 13.3187 21.5723 13.296C22.7722 13.2050 23.4736 12.4909 23.4736 11.2900C23.4736 10.0890 22.6359 9.35214 21.4133 9.35214Z" fill={logoFill} stroke="none"></path>
                          <path d="M6.44029 37.2038V21.2559C6.44563 19.5053 6.71153 19.0011 8.60086 18.9998C9.43462 18.9998 11.7208 18.9998 11.7208 18.9998C19.0309 18.9998 22.4034 22.5638 22.4034 27.9747C22.4034 33.0955 18.4550 37.1717 13.3616 37.2038H6.44029ZM51.6092 37.2038H33.8088V20.8854C33.8088 19.4718 34.0934 19.0011 36.0389 19.0011H37.0878V18.64H27.4180V19.0011H28.4188C30.3976 19.0011 30.6876 19.4611 30.6876 20.8854V54.6415C30.6876 54.6415 30.3736 54.6415 30.2493 54.6415C27.6598 54.6415 27.1802 53.1196 26.0444 50.6723C22.5170 43.0761 20.7332 38.4382 11.3787 37.4780L13.1692 37.4846C18.3000 37.5127 25.5113 35.6070 25.5113 27.9132C25.5113 19.1562 15.6023 18.6467 13.0636 18.6387C13.0636 18.6387 5.14421 18.6387 0.0507746 18.6387V18.9998C0.0507746 18.9998 0.420891 18.9998 0.889883 18.9998C2.99834 18.9984 3.31635 19.3916 3.31768 21.2532V52.6248C3.31768 54.3059 2.87675 54.6135 1.06626 54.6415H0.0494385V55.0013H9.71521V54.6415H8.66098C6.99747 54.5880 6.43895 54.3447 6.43895 52.6248V37.5649H8.92688C11.6593 37.5649 13.9695 38.0838 15.7533 39.5335C20.7385 43.5883 21.0191 55.0013 29.3621 55.0013H37.0851V54.6415H36.1925C34.2003 54.6415 33.8075 54.2002 33.8075 52.3761V37.5649H51.6065L51.6011 52.6315C51.5958 54.2885 51.2123 54.6415 49.1987 54.6415C48.7177 54.6415 48.3302 54.6415 48.3302 54.6415V55.0013H57.9960V54.6415C57.9960 54.6415 57.6232 54.6415 57.1422 54.6415C55.2181 54.6415 54.7237 54.2938 54.7224 52.6315V20.8948C54.7224 19.3542 55.1540 19.0011 57.1422 18.9998C57.6232 18.9998 57.9960 18.9998 57.9960 18.9998V18.6387H48.3302V18.9998C48.3302 18.9998 48.7177 18.9998 49.1987 18.9998C51.2110 18.9998 51.5958 19.3354 51.5971 21.0085L51.6051 37.2025L51.6092 37.2038Z" fill={logoFill} stroke="none"></path>
                        </g>
                        <defs>
                      ...
                      <div className="MuiGrid-root MuiGrid-item flex">
                        <button className="p-0" style={iconAndTextStyle}>
                          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="">
                            <path d="M5.37543 19.4979H19.2354V14.5083C19.2354 13.2544 18.2189 12.2379 16.9650 12.2379H7.64581C6.39192 12.2379 5.37543 13.2544 5.37543 14.5083V19.4979Z" stroke="currentColor" strokeWidth="0.75"></path>
                      ...
                      <div className="flex items-center gap-2 relative">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-black" style={iconAndTextStyle}>
                          ...
                          <g mask="url(#mask0_5301_119153)">
                            <path d="M15.0225 6.73622C15.0225 8.59465 13.5160 10.1012 11.6575 10.1012C9.79910 10.1012 8.29254 8.59465 8.29254 6.73622C8.29254 4.87778 9.79910 3.37122 11.6575 3.37122C13.5160 3.37122 15.0225 4.87778 15.0225 6.73622Z" stroke="currentColor" strokeWidth="0.75"></path>
                          </g>
                        </svg>
                        {cartCount > 0 && (
